...
import { bookAppointment, fetchUserBookings } from '@/services/slices/bookingSlice';
...
const AppointmentBooking: React.FC<AppointmentBookingProps> = ({ serviceProviderId, availability }) => {
  ...
  const availableTimes = selectedDate
    ? availability.find(a => a.day === selectedDate.toLocaleDateString('en-US', { weekday: 'long' }))
    : null;
